...
@Controller
@RequestMapping("/pacote/nacional")
public class PacoteNacionalController {
    ...
    public PacoteNacionalController(ClienteRepository clienteRepo, TransporteRepository transporteRepo,
    ...
    public String calcularPacoteNacional(@RequestParam String tipoTransporte,
